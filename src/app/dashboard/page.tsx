...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const loadDashboardStats = async () => {
      ...
      try {
        // Fetch analytics data for current month (using working endpoint for testing)
        const response = await fetch(`/api/analytics-working?userId=${user.uid}&period=month`)
        if (response.ok) {
