...
export function CreditHistory({ onRefresh }: CreditHistoryProps) {
  ...
  const getTransactionBadge = (type: string) => {
    switch (type) {
      case 'topup':
        return <Badge className="bg-green-100 text-green-800 border-green-200">Top Up</Badge>
      case 'deduction':
        return <Badge className="bg-red-100 text-red-800 border-red-200">Deduction</Badge>
      case 'refund':
        return <Badge className="bg-blue-100 text-blue-800 border-blue-200">Refund</Badge>
      case 'bonus':
        return <Badge className="bg-purple-100 text-purple-800 border-purple-200">Bonus</Badge>
      default:
